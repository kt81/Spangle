...
{
    private readonly ConcurrentDictionary<string, LivePlaylist> _streams = new(StringComparer.Ordinal);
    private readonly ConcurrentDictionary<string, HLSPlaylistHandover> _handovers = new(StringComparer.Ordinal);
...
/// <summary>
/// One live playlist's publish/await state. Producers publish; the HTTP layer
/// blocks on <c>WaitForAsync</c> for LL-HLS blocking reloads.
/// </summary>
